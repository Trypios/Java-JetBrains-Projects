...
public class MusicAppConn {
    ...
    /**
     * Makes a GET request to the given Spotify API
     ...
     * or it will have to end by raising Exception.
     */
    ...
    /**
     * Creates a Spotify server for OAuth authorization purposes.
     */
    ...
    /**
     * Display authorization link to the user.
     */
