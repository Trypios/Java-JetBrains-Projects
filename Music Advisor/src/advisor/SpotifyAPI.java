...
public enum SpotifyAPI {
    ...
    /**
     * Sets the correct uri for PLAYLISTS.
    ...
    /**
     * Sends a json request to fetch all categories
     * and returns the category id based on given name.
    ...
    /**
     * Makes a json request to fetch pages for the controller.
    ...
    /**
     * Creates a list of pages from API results of json requests.
